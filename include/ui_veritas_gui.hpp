...
public:
    ...
    {
        veritas_gui->setWindowTitle(QApplication::translate("veritas_gui", "Veritas", 0));
        pushButton_Start->setText(QApplication::translate("veritas_gui", "Start", 0));
        pushButton_Exit->setText(QApplication::translate("veritas_gui", "Exit", 0));
        ...
        pushButton_Help->setText(QApplication::translate("veritas_gui", "Help", 0));
    } // retranslateUi
